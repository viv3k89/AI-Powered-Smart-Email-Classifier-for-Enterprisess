...
This project is an AI-based email classification system designed for enterprise use.  
It automatically categorizes incoming emails and determines their urgency using NLP and deep learning techniques such as BERT embeddings.
